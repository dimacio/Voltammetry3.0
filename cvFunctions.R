# cvSim: function to simulate cyclic voltammetry
...
# be sure to use library(plotly) to invoke the package
...
# tableCV: uses DT to create table of time, potential, and current
# be sure to load the DT and the magrittr libraries
...
extstd = function(x, y, ...) {
  plot(x, y, pch = 19, cex = 1.25, col = "blue", ...)
  lm.out = lm(y~x)
